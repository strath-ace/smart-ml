...
def getLSF(): # this runs an FEA and creates the inputs for the ANNs.
#        
...
#        Mdb.jobs['Design_Job'+str(Iter)].waitForCompletion() # wait for the job to complete
        ...
        #print(str(opdb.steps['Step-1'].historyRegions.keys()))
